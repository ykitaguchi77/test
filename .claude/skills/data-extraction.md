...
- `paper_identity.json` - Identifying metadata (title, authors, journal, DOI, PMCID) — NOT included in the bundle
...
- `extracted_data_bundle.md` - Combined file with all extracted data (anonymized)

**NOTE**: Do NOT extract the reference list from the original paper. References will be independently discovered in Phase 3.5 based on the draft's content, to maintain blind integrity.
